...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            config.temp_branch_name = core.getInput(inputs_1.default.temp_branch_name);
            config.master_branch_name = core.getInput(inputs_1.default.master_branch_name);
            config.commit_message = core.getInput(inputs_1.default.commit_message);
            config.pull_title = core.getInput(inputs_1.default.pull_title);
            ...
            output.push((0, child_process_1.execSync)(`composer validate --strict`));
            core.info('Step 3: No Cache Composer packages');
            output.push((0, child_process_1.execSync)(`composer install --prefer-dist --no-progress`));
      ...
      git add .`));
            ...
            if (output1.toString()) {
                ...
                core.info(`https://${config.github_token}@github.com/${config.repository}.git`);
                core.info('Step 8: Deleting Previous Branches');
                output.push((0, child_process_1.execSync)(`git remote add target https://${config.github_token}@github.com/${config.repository}.git
          git fetch target
